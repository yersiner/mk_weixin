<template>
  <div id="" :class="hide ? 'mshow' : 'mhide'">
    <div class="weui-mask" :class="show ? 'weui-animate-fade-in' : 'weui-animate-fade-out'"></div>
    <div class="area_ctrl weui-picker" :class="show ? 'weui-animate-slide-up' : 'slideInDown'">
...
<style scoped>
  ...
  .slideInUp {
      -webkit-animation: slideInUp .3s forwards;
